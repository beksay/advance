...
@ManagedBean
@ViewScoped
public class AlumniList extends BaseController implements Serializable {
	...
	public void filterData() {
		...
		filters.add(new FilterExample("status", PersonStatus.ALUMNI, InequalityConstants.EQUAL));
		if (fullName != null) {
