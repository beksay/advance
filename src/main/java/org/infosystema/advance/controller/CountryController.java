...
import org.infosystema.advance.conversation.ConversationCountry;
...
public class CountryController {
	...
	public void onRowSelect(SelectEvent event) throws IOException {
		...
		conversation.setCountry(country);
        FacesContext.getCurrentInstance().getExternalContext().redirect("/advance/view/country/city_list.xhtml?cid="+conversation.getId());
