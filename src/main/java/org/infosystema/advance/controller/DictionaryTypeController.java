...
import org.infosystema.advance.conversation.ConversationDictType;
...
public class DictionaryTypeController {
	...
	public void onRowSelect(SelectEvent event) throws IOException {
		...
		conversation.setDictionaryType(dictionaryType);
        FacesContext.getCurrentInstance().getExternalContext().redirect("/advance/view/dictionary/dictionary_list.xhtml?cid="+conversation.getId());
